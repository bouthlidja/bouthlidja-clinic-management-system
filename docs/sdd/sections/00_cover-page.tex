...
% أضف هنا جدول التعاريف أو القائمة حسب الحاجة
% مثال:
% \begin{longtable}{|p{3cm}|p{10cm}|}
	% \hline
	% \textbf{Term} & \textbf{Definition} \\ \hline
	% EMR & Electronic Medical Record \\ \hline
	% MVC & Model-View-Controller \\ \hline
	% \end{longtable}
	\end{document}  % لا تضع هذا السطر لأنه ليس نهاية المستند، ولكنني وضعته للتوضيح فقط