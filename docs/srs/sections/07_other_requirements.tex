...
\subsection*{Clinical Use Case Analysis}
\begin{table}[H]
	\centering
	\renewcommand{\arraystretch}{1.3}
	\begin{tabularx}{\textwidth}{l X l}
...
\subsection*{Patient Interaction Analysis}
\begin{table}[H]
	\centering
	\renewcommand{\arraystretch}{1.3}
	\begin{tabularx}{\textwidth}{l X l}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{l X l}
		\toprule
		\textbf{Category} & \textbf{Technical Description} & \textbf{Key Use Cases} \\
		\midrule
		Patient Intake & Registering and verifying patient identity & Search/Register \\
		Scheduling & Managing the doctor's calendar & Create/Reschedule \\
		Billing & Converting visits to financial claims & Invoice/Receipt \\
		Operational Check & Updating arrival status (Check-In) & Physical arrival \\
		\bottomrule
	\end{tabularx}
\end{table}
